# YubiKey 冷钱包实战（三）：使用 FIDO2 PRF 派生 KEK 加密以太坊私钥（AES-GCM 实现）
...
不是.PRF 提供的是硬件绑定的密钥派生能力,而非直接链上签名.

### 如果丢失 YubiKey 会怎样？

若未做备份,无法解密 keystore,因此必须做好凭证备份策略.

### PRF 输出是否可以直接作为 AES 密钥
...
> 作者: <no value>  
> URL: https://www.lucas6.xyz/keys/yubikey-fido2-prf-kek-ethereum-cold-wallet/  
